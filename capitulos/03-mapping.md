...
Si queremos usar expresiones regulares, disponemos de la directiva `AliasMatch`.

## Redirección

En el caso de la redirección se informa al cliente que el recurso está en otra *URL*, e instruye al navegador para que realice una nueva *request* a la nueva *URL*.
...
En este caso, la primera redirección (permanente) se refiere a la página raíz ***/***, y la segunda (temporal) redirigirá todas las solicitudes a la página especificada (en otro servidor).
